...
export function UpdateAnnotationRecord(props: UpdateRecordProps) {
    const [annotationRecord, setAnnotationRecord] = React.useState<
        AnnotationTasks | undefined
    >(undefined);
